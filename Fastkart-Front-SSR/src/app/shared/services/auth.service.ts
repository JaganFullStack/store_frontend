...
import { AuthUserForgotModel,  } from "./../interface/auth.interface";
...
export class AuthService {
  ...
  //   return this.http.post<any>(apiUrl, { headers: headers }).pipe(
  //     catchError(HttpErrorResponse => {
  ...
  Emailvalidation(payload: AuthUserForgotModel): Observable<any> {
    ...
    const apiUrl = `${environment.apiBaseUrl}/api/forgetpassword`;
